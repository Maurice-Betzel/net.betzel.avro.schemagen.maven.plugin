...
public class PolymorphicInnerClassesTest {

    private static Logger LOGGER = LoggerFactory.getLogger(PolymorphicInnerClassesTest.class);

    @Test
    public void testPolymorphicInnerClasses () throws IOException {
    ...
    private static class HotHatchback extends Car {

        public double horsepower;

    }

    private static class Convertible extends Car {
